/** ---------------------------------------------------------------------------
 * \file        EcLogging.h
 * \brief       EC-Master application logging header
...
#if (EC_OS == EC_OS_RTX)
    #define EC_LOGGING_PATH_PREFIX   "C:\\"
#else
    #define EC_LOGGING_PATH_PREFIX   ""
#endif
...
#if (defined WIN32) && (!defined UNDER_CE) && (EC_OS != EC_OS_RTOS32)
...
#endif /* INCLUDE_EC_MASTER || INCLUDE_EC_MONITOR || INCLUDE_EC_SIMULATOR || INCLUDE_EC_EAP || EC_RAS_CLIENT */
...
public:
    EC_T_DWORD Open(const EC_T_CHAR* szFilename)
    {
        ...
        OsSafeStrncpy(m_szFileName, szFilename, dwFileNameLen + 1 + OsStrlen(".00000.pcap"));
...
public:
    ...
    virtual EC_T_DWORD InitInstance(EC_T_DWORD dwBufCnt) { return CPcapFileBufferedWriter::InitInstance(dwBufCnt); }
