/** ---------------------------------------------------------------------------
 * \file
 * \brief       EC-Master / EC-Simulator feature selection
...
#endif
#if (!defined INCLUDE_MASTER_RED) && (!defined EXCLUDE_MASTER_RED) && ((EC_OS == EC_OS_LINUX) || (EC_OS == EC_OS_QNX) || (EC_OS == EC_OS_WINDOWS))
